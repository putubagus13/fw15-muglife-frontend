...
const ManageOrders = () => {
  return (
    <>
      ...
      <div>
        <div className={`${styles.bg_order} bg-no-repeat bg-cover font-rubik pt-[100px]`}>
          <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="absolute bg-[#4b3529] mt-[-10%] w-[350px] h-[524px] rounded-lg drop-shadow-2xl flex flex-col">
                      <div>
                        <div className="text-center pt-[10%]">
                          <div className="font-bold text-[#E5E5CB] text-[35px]">Delivery Order</div>
                          <div className="text-[#E5E5CB]">For Zulaikha</div>
                        </div>

                        <div className="flex gap-[33px] px-[5%] mt-[5%]">
                          <div>
                            <Image src={hazelnut} width="90" height="82" className="rounded-lg bg-cover" alt="desc"></Image>
                          </div>
                        ...
                        <div className="flex gap-[33px] px-[5%] mt-[5%]">
                          <div>
                            <Image src={wings} width="90" height="82" className="rounded-lg bg-cover" alt="desc"></Image>
                          </div>
                          <div className="text-[#E5E5CB] text-[14px]">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <button className="w-[60%] md:w-[50%] bg-[#D5CEA3] hover:bg-[#e0d9ab] text-[#4b3529] text-[20px] font-semibold py-[27px] rounded-lg mt-[47px] mb-[5%]"> Mark as done</button>
            </div>
          </div>
        </div>
      </div>
