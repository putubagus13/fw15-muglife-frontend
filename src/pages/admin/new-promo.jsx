            ...
            <main className="pt-28">
                <div className="w-full flex flex-col items-start justify-start gap-11 px-5 sm:px-11 lg:px-36 py-11">
                    <div className="w-full text-lg font-semibold">
                        Fafourite Promo <span className="text-lg text-primary font-semibold">{`>`} Add new promo</span>
                    </div>
                    <div className="w-full flex flex-col md:flex-row items-start justify-between gap-11 lg-gap-0">
                        <div className="w-full md:w-[40%] flex flex-col items-center gap-7">
                            ...
                            <div className="w-full md:max-w-[400px] flex flex-col items-start justify-start gap-3">
                                <div className="text-xl text-primary font-semibold">Enter the discount</div>
                                <div className="w-full">
                                    <input type="text" className="w-full input input-accent" placeholder="Input Discount %" />
                                </div>
                            </div>

                            <div className="w-full md:max-w-[400px] flex flex-col items-start justify-start gap-3">
                                <div className="text-xl text-primary font-semibold">Expire date :</div>
                                <div className="w-full">
                                    <div className="text-sm">Input start date</div>
                                    <input type="date" name="" id="" className="w-full input input-accent" placeholder="Input start hour" />
                                </div>
                                <div className="w-full">
                                    <div className="text-sm">Input end date</div>
                                    <input type="date" name="" id="" className="w-full input input-accent" placeholder="Input end hour" />
                                </div>
                            </div>
                            <div className="w-full md:max-w-[400px] flex flex-col items-start justify-start gap-3">
                                <div className="text-xl text-primary font-semibold">Input coupon code</div>
                                <div className="w-full">
                                    <input type="text" className="w-full input input-accent" placeholder="Input coupon code" />
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-[60%] flex flex-col items-center">
                            <div className="w-full md:max-w-[600px] flex flex-col items-start gap-12">
                                ...
                                <div className="w-full flex flex-col items-start gap-2 ">
                                    <div className="w-full text-primary text-lg font-semibold">Normal Price :</div>
                                    <div className="w-full border-b border-secondary">
                                        <input type="text" name="" id="" className=" h-11 border-none outline-none w-full text-primary bg-transparent" placeholder="Type  normal price" />
                                    </div>
                                </div>
                                <div className="w-full flex flex-col items-start gap-2 ">
                                    <div className="w-full text-primary text-lg font-semibold">Description :</div>
                                    <div className="w-full border-b border-secondary">
                                        <input type="text" name="" id="" className=" h-11 border-none outline-none w-full text-primary bg-transparent" placeholder="Describe your promo min. 150 characters" />
                                    </div>
                                </div>
