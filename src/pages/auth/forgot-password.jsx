                        ...
                        <form onSubmit={doForgotPassword} className="flex flex-col items-center justify-center gap-11">
                            ...
                            <div className="flex flex-col gap-3 w-full px-5">
                                ...
                                <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-6">
                                    <div className="w-full md:w-[550px] h-16">
                                        <input type="email" name="email" className="input input-accent  text-secondary bg-white w-full h-full" placeholder="Enter your email adress to get link" />
                                    </div>
                                    <div className="w-full sm:w-[150px] h-16 ">
                                        {minutes === 0 && seconds === 0 ? (
                                            <button onClick={handleStartCountdown} className="btn btn-accent w-full h-full text-primary text-xl capitalize shadow-lg shadow-stone-500/50">
                                                Send
                                            </button>
                                        ) : (
                                            <button disabled={true} className="btn btn-accent w-full h-full text-primary text-xl capitalize shadow-lg shadow-stone-500/50">
                                                <MdOutlineDisabledVisible size={50} />
                                            </button>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="w-full flex flex-col items-center justify-center gap-5 px-5">
                                ...
                                <div className="w-full md:w-[300px] h-16">
                                    {minutes === 0 && seconds === 0 ? (
                                        <button onClick={handleStartCountdown} className="btn btn-secondary w-full h-full text-white text-xl capitalize shadow-lg shadow-orange-900/50">
                                            Resend Link
                                        </button>
                                    ) : (
                                ...
                                {minutes === 0 && seconds === 0 ? (
                                    <div className="hidden text-center text-2xl text-white font-semibold">
