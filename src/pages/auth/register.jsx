  ...
  return (
    <>
      ...
      <main className="w-full">
        <div className=" w-full flex bg-login-pattern bg-no-repeat bg-cover justify-center items-center">
          <div className="hidden sm:block basis-2/5 lg:basis-2/4 xl:basis-3/5  w-full h-full"></div>
          <div className="md:basis-3/5 lg:basis-2/4 xl:basis-2/5 bg-white w-full pb-24">
            <div className="w-full h-full flex flex-col items-center justify-center gap-11 py-11 pl-4 md:pl-16 pr-4 md:pr-24">
              ...
              <form onSubmit={doRegister} className="form-control w-full lg:max-w-[500px] h-full flex flex-col items-start justify-start gap-7">
                ...
                <div className="w-full flex flex-col items-start justify-start gap-3 shadow-md mt-5">
                  <button type="submit" disabled={loading} className="btn btn-accent text-primary text-base capitalize w-full">
                                        Sign Up
                  </button>
                </div>
