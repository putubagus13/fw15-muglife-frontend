        ...
        <>
            ...
            <main className="w-full h-screen">
                <div className=" w-full h-screen">
                    <div className={`${styles.bg_forgot} bg-no-repeat bg-cover w-full h-full flex justify-center items-center`}>
                        <form onSubmit={doResetPassword} className="flex flex-col items-center justify-center gap-11">
                            ...
                            <div className="w-full flex flex-col items-center justify-center gap-9 px-5">
                                ...
                                {successMessage && (
                                    <div className="flex flex-row justify-center alert alert-success shadow-lg text-white text-lg w-full my-2">
                                        <BsCheckCircleFill size={30} />
                                        {successMessage}
                                    </div>
                                )}
                                <div className="relative form-control w-full md:w-[550px]">
                                    <input type={showEye ? 'text' : 'password'} name="newPassword" className="input input-accent text-secondary bg-white w-full h-16" placeholder="Enter your new password" />
                                    ...
                                    <button type="button" onClick={doShowEye}>
                                        {showEye ? <FiEyeOff size={27} className="absolute text-secondary top-5  right-5" /> : <FiEye size={27} className="absolute text-secondary top-5 right-5" />}
                                    </button>
                                </div>
                                <div className="relative form-control w-full md:w-[550px]">
                                    <input type={openEye ? 'text' : 'password'} name="confirmPassword" className="input input-accent text-secondary bg-white w-full h-16" placeholder="Enter your confirm password" />
                                    ...
                                    <button type="button" onClick={doOpenEye}>
                                        {openEye ? <FiEyeOff size={27} className="absolute text-secondary top-5  right-5" /> : <FiEye size={27} className="absolute text-secondary top-5 right-5" />}
                                    </button>
                                </div>
                                <div className="w-full md:w-[550px] h-16">
                                    {loading ? (
                                        <button className="w-full h-full btn btn-accent text-primary text-xl capitalize shadow-lg shadow-stone-500/50">
                                            <span className="loading loading-spinner loading-sm"></span>
                                        </button>
                                    ) : (
                                        <button type="submit" className="w-full h-full btn btn-accent text-primary text-xl capitalize shadow-lg shadow-stone-500/50">
                                            Reset
                                        </button>
                                    )}
                                </div>
                                <span className="text-xl text-primary">
                                    Password reset was successful, please{' '}
