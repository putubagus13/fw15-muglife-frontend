    ...
    <div>
      ...
      <header className={`${styles.bg_landing} hero h-[100vh] w-full md:px-20`}>
        <div className="flex gap-10 flex-col md:flex-row text-left justify-between text-neutral-content w-full h-full">
          <div className="flex-1 flex px-6 md:px-0 pt-60 md:pr-24 flex-col gap-5">
            <h1 className="text-6xl text-white font-bold">Start Your Day with Coffee and Good Meals</h1>
            <p className="text-white">We provide high quality beans, good taste, and healthy meals made by love just for you. Start your day with us for a bigger smile!</p>
            <div className="w-full flex justify-start">
              <button className="btn bg-[#D5CEA3] text-[#3C2A21] border-none hover:text-[#D5CEA3] px-10 font-bold capitalize">Get Started</button>
            </div>
          </div>
      ...
      <section className="flex flex-col md:flex-row lg:flex-row mt-20 px-5 md:px-20">
        ...
        <div className="basis-0 md:basis-1/2 lg:basis-1/2 pl-10 flex flex-col gap-5">
          <h1 className="text-4xl font-bold text-[#3C2A21]">We Provide Good Coffee and Healthy Meals</h1>
          <p className="text-md text-[#846c60] font-semibold">You can explore the menu that we provide with fun and have their own taste and make your day better.</p>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-gray-500 font-medium">Healthy meals, you can request the ingredients</p>
            </div>
            <div className="flex items-center gap-2">
              <div className="bg-green-700 rounded-full">
                <Check className="text-white p-1" />
              </div>
              <p className="text-sm text-gray-500 font-medium">Chat with our staff to get better experience for ordering</p>
            </div>
            <div className="flex items-center gap-2">
              <div className="bg-green-700 rounded-full">
                <Check className="text-white p-1" />
              </div>
              <p className="text-sm text-gray-500 font-medium">Free member card with a minimum purchase of IDR 200.000.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-[#e2dcb2] lg:h-[1250px] w-full flex flex-col items-center">
        <div className=" block pt-[80px] text-center mb-[90px]">
          <p className="text-[#3C2A21] text-[35px] leading-[50px] font-bold mb-[19px]">Here is People’s Favorite</p>
          ...
          <div className="lg:carousel carousel-center lg:flex gap-5 gap-20 w-full lg:px-5 justify-center">
            <div className="carousel-item">
              <div className="w-80 flex flex-col justify-center items-center py-5 border-2 bg-white rounded-[10px] pt-[62px] pb-[50px] mb-[30px]">
                ...
                <p className="text-[#3C2A21] text-[25px] font-bold leading-[30px] text-center mb-[20px]">IDR 25.000</p>
            ...
            <div className="carousel-item">
              <div className="w-80 flex flex-col justify-center items-center py-5 border-2 bg-white rounded-[10px] pt-[62px] pb-[50px] mb-[30px]">
                ...
                <p className="text-[#3C2A21] text-[25px] font-bold leading-[30px] text-center mb-[20px]">IDR 30.000</p>
                <div className="flex justify-center">
                  <div className="flex justify-center">
                    <button className="btn btn-outline outline-[#3C2A21] hover:bg-[#3C2A21] hover:text-[#E5E5CB] rounded-full w-36 font-bold capitalize text-[#6A4029]">
                      <Link href="#">Order Now</Link>
      ...
      <section className="px-5 md:px-20 flex flex-col justify-center items-center mt-20">
        <h1 className="text-3xl text-[#3C2A21] font-bold md:w-[350px] text-center">Visit Our Store in the Spot on the Map Below</h1>
        <p className="mt-10 mb-20 text-[#846c60] md:w-[500px] text-center">See our store in every city on the spot and spen your good day there. See you soon!</p>
        <div>
      ...
      <section className="px-5 md:px-20 mt-20 flex flex-col justify-center items-center">
        <h1 className="text-3xl text-[#3C2A21] font-bold md:w-[350px] text-center">Our Partner</h1>
        <div className="flex flex-wrap justify-center mt-10 gap-10">
          <Image className="w-[170px] h-[40px]" src={netflix} alt="netflix" />
          <Image className="w-[170px] h-[40px]" src={reddit} alt="reddit" />
          <Image className="w-[170px] h-[40px]" src={amazon} alt="amazon" />
          <Image className="w-[170px] h-[40px]" src={discord} alt="discord" />
          <Image className="w-[170px] h-[40px]" src={spotify} alt="spotify" />
        </div>
      </section>
      {/* Testimoni */}
      <section className="md:px-20 mt-20">
        <div className="text-center w-full flex flex-col justify-center items-center">
          <h1 className="text-3xl text-[#3C2A21] font-bold md:w-[350px] lg:w-[350px]">Loved by Thousands of Happy Customer</h1>
          <p className="mt-5 mb-10 text-[#846c60] md:w-[500px] lg:w-[500px] text-center">These are the stories of our customers who have visited us with great pleasure.</p>
        </div>
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="border border-[#6A4029] rounded-lg p-7 sm:w-full">
            ...
            <div className="mt-5 text-sm">
              <p className="font-medium text-[#846c60]">“Wow... I am very happy to spend my whole day here. the Wi-fi is good, and the coffee and meals tho. I like it here!! Very recommended!</p>
            </div>
          </div>
          <div className="border rounded-lg p-7 sm:w-full">
            ...
            <div className="mt-5 text-sm">
              <p className="font-medium text-[#846c60]">“I like it because I like to travel far and still can make my day better just by drinking their Hazelnut Latte</p>
            </div>
          </div>
          <div className="border rounded-lg p-7 sm:w-full">
            <div className="flex items-center">
            ...
            <div className="mt-5 text-sm">
              <p className="font-medium text-[#846c60]">“This is very unusual for my taste, I haven’t liked coffee before but their coffee is the best! and yup, you have to order the chicken wings, the best in town!</p>
            </div>
          </div>
        </div>
      ...
      <section className="md:px-20 px-5 my-20">
        <div className="rounded-md shadow-xl px-16 py-14 flex flex-col md:flex-row lg:flex-row items-center gap-5">
          <div className="grow text-center md:text-left lg:text-left">
            <h1 className="text-3xl text-[#3C2A21] font-bold w-60 mb-2">Check our promo today!</h1>
            <p className="font-medium text-[#846c60]">Let&apos;s see the deals and pick yours!</p>
          </div>
          <div>
            <Link href="/">
              <button className="btn bg-[#D5CEA3] text-[#3C2A21] hover:text-[#D5CEA3] capitalize shadow-xl w-44">See Promo</button>
            </Link>
          </div>
        </div>
      </section>
