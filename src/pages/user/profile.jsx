    ...
    return (
        <>
            ...
            <main className="pt-28">
                ...
                <form onSubmit={handleSubmit} className="w-full bg-payment-pattern bg-no-repeat bg-cover py-11 px-7 lg:px-36 xl:px-64">
                                        ...
                                        <div className="flex-1 w-full flex flex-col items-start justify-start gap-7">
                                            ...
                                            <div className="flex w-full flex-col items-start gap-3 ">
                                                <div className="text-lg text-primary flex items-center gap-3">
                                                    ...
                                                    <label onChange={handleChange} onBlur={handleBlur} htmlFor="genChoiceMale">Male</label>
                                                </div>
                                                <div className="text-lg text-primary flex items-center gap-3">
                                                    <input type="radio" name="gender" id="genChoiceFem" value='1' />
                                                    <label onChange={handleChange} onBlur={handleBlur} htmlFor="genChoiceFem">Female</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="w-full md:basis-4/12">
                            <div className="w-full min-h-[450px] rounded-2xl ">
                                <div className="w-full h-[96%] flex flex-col items-center justify-between gap-8 px-5 py-11 rounded-t-2xl">
                                    ...
                                    <div className="w-full flex flex-col items-center justify-center">
                                        <button type='submit' className="w-full btn btn-secondary text-white capitalize rounded-xl">Save Changes</button>
                                    </div>
                                    <div className="w-full flex flex-col items-center justify-center">
                                        <button type='reset' className="w-full btn btn-accent text-primary capitalize rounded-xl">Cancel</button>
                                    </div>
