            ...
            <main className="pt-28">
                ...
                >
                    {({ handleSubmit, handleChange, handleBlur, errors, touched, values }) => (
                        <>
                            <form onSubmit={handleSubmit} className={`${styles.bg_profile} w-full bg-no-repeat bg-cover py-16 px-7 lg:px-36 xl:px-64`}>
                                            ...
                                            <div className="w-full flex flex-col items-center justify start gap-5 px-5 md:px-11 py-12 rounded-t-2xl  bg-white">
                                                <div className="relative w-24 h-24">
                                                    <label className="cursor-pointer absolute bottom-0 right-0 w-7 h-7 rounded-full bg-secondary flex items-center justify-center">
                                                        {!pictureURI ? <input name="picture" type="file" className="hidden" onChange={changePicture} /> : null}
                                                    ...
                                                    <div className="w-24 h-24 overflow-hidden rounded-full flex justify-center items-center">
                                                        ...
                                                        {!pictureURI && <>{profile?.picture === null ? <FiUser size={100} /> : <Image src={profile?.picture} width={96} height={96} alt="" />}</>}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="w-full flex flex-col md:flex-row items-start justify-between gap-7">
                                                    <div className="flex-1 w-full flex flex-col items-start justify-between gap-7">
                                                        <div className="flex w-full flex-col items-start gap-3 border-b border-primary">
                                                            ...
                                                            {editContacts && <input onChange={handleChange} onBlur={handleBlur} value={values.email} type="email" name="email" className="outline-none text-primary" />}
                                                        </div>
                                                        <div className="flex w-full flex-col items-start gap-3 border-b border-primary">
                                                            <div className="text-lg text-accent">Delivery Address:</div>
                                                            {!editContacts && <div className="text-primary">{profile.address}</div>}
                                                            {editContacts && <input onChange={handleChange} onBlur={handleBlur} value={values.address} type="text" name="address" className="outline-none text-primary" />}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex-1 w-full flex flex-col items-start justify-between gap-7">
                                                        ...
                                                        <div className="flex w-full flex-col items-start gap-3 border-b border-primary">
                                                            ...
                                                            {!editDetails ? (
                                                                ...
                                                                <input onChange={handleChange} onBlur={handleBlur} value={values.firstName} type="text" name="firstName" className="outline-none text-primary" />
                                                            )}
                                                        </div>
                                                        <div className="flex w-full flex-col items-start gap-3 border-b border-primary">
                                                            ...
                                                            {!editDetails ? (
                                                                ...
                                                                <input onChange={handleChange} onBlur={handleBlur} value={values.lastName} type="text" name="lastName" className="outline-none text-primary" />
                                                            )}
                                                        </div>
                                                    </div>
                                                    <div className="flex-1 w-full flex flex-col items-start justify-start gap-7">
                                                        <div className="flex w-full flex-col items-start gap-3 border-b border-primary">
                                                            ...
                                                            {!editDetails ? (
                                                                ...
                                                                <input onChange={handleChange} onBlur={handleBlur} value={values.fullName} type="date" className="outline-none text-primary" />
                                                            )}
                                                        </div>
                                        ...
                                        <div className="w-full min-h-[350px] rounded-2xl ">
                                            <div className="w-full flex flex-col items-center justify-between gap-5 px-5 rounded-t-2xl">
                                                ...
                                                <div className="w-full flex flex-col items-center justify-center mt-7">
                                                    <button type="button" onClick={() => openModal()} className="w-full btn btn-neutral text-primary capitalize rounded-xl flex items-center justify-between">
